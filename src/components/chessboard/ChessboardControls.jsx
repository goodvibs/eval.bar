    ...
    return (
        <div className="flex flex-1 gap-2 items-center px-2">
            ...
            <button onClick={firstMove} className="rounded-full bg-slate-600 hover:bg-slate-500 transition duration-100">
                <svg className="fill-slate-300 rotate-180" xmlns="http://www.w3.org/2000/svg" height="48" width="48" viewBox="0 -960 960 960">
            ...
            <button onClick={previousMove} className="rounded-full bg-slate-600 hover:bg-slate-500 transition duration-100">
                <svg className="fill-slate-300 -translate-x-0.5 rotate-180" xmlns="http://www.w3.org/2000/svg" height="48" width="48" viewBox="0 -960 960 960">
            ...
            <button onClick={nextMove} className="rounded-full bg-slate-600 hover:bg-slate-500 transition duration-100">
                <svg className="fill-slate-300 translate-x-0.5" xmlns="http://www.w3.org/2000/svg" height="48" width="48" viewBox="0 -960 960 960">
                    <path d="M517.85-480 354.92-642.92q-8.3-8.31-8.5-20.89-.19-12.57 8.5-21.27 8.7-8.69 21.08-8.69 12.38 0 21.08 8.69l179.77 179.77q5.61 5.62 7.92 11.85 2.31 6.23 2.31 13.46t-2.31 13.46q-2.31 6.23-7.92 11.85L397.08-274.92q-8.31 8.3-20.89 8.5-12.57.19-21.27-8.5-8.69-8.7-8.69-21.08 0-12.38 8.69-21.08L517.85-480Z"/>
                </svg>
            </button>
