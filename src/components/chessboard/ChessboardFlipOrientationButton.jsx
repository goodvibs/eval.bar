export function ChessboardFlipOrientationButton({ orientedWhite, setOrientedWhite }) {
    return (
        <button
            onClick={() => setOrientedWhite(!orientedWhite)}
            className="rounded-lg bg-slate-600 hover:bg-slate-500 h-8 w-8 p-1 fill-slate-400 hover:fill-slate-300 transition duration-100"
        >
