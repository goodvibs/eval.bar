...
export function DonateButton() {
    return (
        ...
        >
            <svg className="h-5 w-5 sm:h-3 sm:w-3" viewBox="0 0 16 16" fill="currentColor">
            ...
            <span className="hidden sm:inline text-xs font-semibold tracking-wider uppercase">Donate</span>
        </a>
    )
}