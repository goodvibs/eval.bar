...
export function AnalysisSettingsMenu({ settingsRef, showSettings, isAnalysisOn, handleGoalDepthChange, handleMultiPVChange, goalSearchDepth, multiPV }) {
    return (
        <div
            ref={settingsRef}
            className={`absolute right-0 transform backdrop-blur bg-opacity-90 origin-top-right transition-all duration-200 ease-out ${
                showSettings
        ...
        >
            <h3 className="text-slate-200 text-lg font-semibold mb-3">Engine Settings</h3>
