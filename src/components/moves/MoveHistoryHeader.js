            ...
            <div className="flex items-center gap-2">
                ...
                <TooltipContainer tooltip="Analyze on Lichess.org">
                    <button
                        ...
                        className="text-xs bg-blue-500 hover:bg-blue-400 text-white transition-colors px-3 py-1.5 rounded flex items-center gap-1 uppercase tracking-wider font-semibold"
                    >
