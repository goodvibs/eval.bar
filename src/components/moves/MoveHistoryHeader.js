            ...
            <div className="flex items-center gap-2">
                ...
                <TooltipContainer tooltip="Analyze on Lichess.org">
                    <button
                        ...
                        className="text-xs bg-blue-500 hover:bg-blue-400 text-white transition-colors px-1 py-1.5 rounded flex items-center gap-1 uppercase tracking-wider font-semibold"
                    >
                        <svg className="w-4 h-4 fill-slate-50" viewBox="-12 -12 74 74" xmlns="http://www.w3.org/2000/svg">
